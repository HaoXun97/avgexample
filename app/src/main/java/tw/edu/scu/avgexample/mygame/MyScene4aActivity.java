        ...
        if ("tool_selection".equals(identifier)) {
            ...
            switch (index) {
                ...
                case 1:
                    ...
                    KWThirdPersonEventModel eventRetryy = new KWThirdPersonEventModel(character, "選擇好像有點奇怪喔，要不要重新選呢？");
                    eventManager.addEvent(eventGlue);
                    eventManager.addEvent(eventRetryy);
                    eventManager.play("Scene4a_ToolSelection");
                    break;
                case 2:
                ...
                case 3:
                    ...
                    KWThirdPersonEventModel eventRetryyy = new KWThirdPersonEventModel(character, "選擇好像有點奇怪喔，要不要重新選呢？");
                    eventManager.addEvent(eventMystery);
                    eventManager.addEvent(eventRetryyy);
                    eventManager.play("Scene4a_ToolSelection");
                    break;
